  ...
  <div class="Huiform">
    <form action="/upload/update" method="post">
      <table class="table table-bg">
        <tbody>
          <tr>
            <th width="100" class="text-r"><span class="c-red">*</span> 旧视频名：</th>
          ...
          <tr>
            <th width="100" class="text-r"><span class="c-red">*</span> 新视频名：</th>
            <td><input type="text" style="width:200px" class="input-text" value="" placeholder="" id="url" name="url" datatype="*2-16" nullmsg="视频名不能为空"></td>
          </tr>
          <tr>
            <th></th>
